package arrayList.jesse.test;

import java.util.ArrayList;
import java.util.Iterator;

import arrayList.jesse.model.Item;
...
public class TestArrayList {
	public static void main(String[] args) {
	    ...
	    while (iter.hasNext()) {
	          ...
	          iter.remove();
	          items.add(new Item(6, "This is a new item")); // <--  not allowed because you're trying to alter 
	          												//      collection (outside of calling and remove 
	          												//      method).
	     }
